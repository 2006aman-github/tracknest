...
const Form = () => {
    ...
    const handleLogin = (e, role, credentials) => {
        e.preventDefault();
        dispatch(login({ user: { name: credentials.email.split("@")[0], email: credentials.email }, role }));
    };
            ...
            <div className="flex gap-10 flex-wrap justify-center">
                ...
                <Card className="w-[360px] shadow-lg rounded-2xl">
                    <CardContent className="p-6 space-y-6">
                        ...
                        <form onSubmit={(e) => handleLogin(e, "user", user)} className="space-y-4">
                            <Input
                                type="email"
                ...
                <Card className="w-[360px] shadow-lg rounded-2xl">
                    <CardContent className="p-6 space-y-6">
                        ...
                        <form onSubmit={(e) => handleLogin(e, "admin", admin)} className="space-y-4">
                            <Input
                                type="email"
                ...
                <Card className="w-[360px] shadow-lg rounded-2xl">
                    <CardContent className="p-6 space-y-6">
                        ...
                        <form onSubmit={(e) => handleLogin(e, "provider", provider)} className="space-y-4">
                            <Input
                                type="email"
